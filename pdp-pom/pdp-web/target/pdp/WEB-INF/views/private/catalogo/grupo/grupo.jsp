...
<div class="container-fluid">
		...
		<div class="row clearfix">
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">             
                      <div class="card">  
                       ...
                       <div class="header"> 
                             ...
                             <form  id="formGrupoElementoBusq">
                                <div class="row clearfix">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                        <div class="form-group">
                                        	<label>Nombre</label>
                                            <div class="form-line">
                                                <input type="text" id="nombreBusq" name="nombreBusq" class="form-control" placeholder="Nombre Grupo">
                                            </div>
                                        </div>
                                    </div>
                                   	...
                                   	<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                        <button type="button" id="btnBuscarGrupoElemento" name="btnBuscarGrupoElemento" class="btn btn-primary btn-lg m-l-15 waves-effect">Buscar</button>
										<a href="grupo/grupo_form" id="btnAddGrupoElemento" name="btnAddGrupoElemento" class="btn btn-primary btn-lg m-l-15 waves-effect">Agregar</a>
                                    </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            <table id="grupoElementoGrid" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>NOMBRE</th>
    ...
    <script src="<c:url value="/js/pages/grupo/grupo.js"/>"></script>
