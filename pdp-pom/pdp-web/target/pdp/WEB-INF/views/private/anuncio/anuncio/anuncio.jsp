...
<div class="container-fluid">
		...
		<div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                       				 ...
                       				 <div class="col-lg-3 col-md-3 col-sm-3 ">
		                                    ...
		                                    <select name="tipoAnuncioBusq" id="tipoAnuncioBusq" class="form-control show-tick">
                                   	...
                                   	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                        <button type="button" id="btnBuscarAnuncio" name="btnBuscarAnuncio" class="btn btn-primary btn-lg m-l-15 waves-effect">Buscar</button>
										<a href="anuncio/anuncio_form" id="btnAddAnuncio" name="btnAddAnuncio" class="btn btn-primary btn-lg m-l-15 waves-effect">Agregar</a>
                                    </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            <table id="anuncioGrid" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>TITULO</th>
    ...
    <script src="<c:url value="/js/pages/anuncio/anuncio.js"/>"></script>
