...
<div class="container-fluid">
		...
		<div class="row clearfix">
                               ...
                               <div class="row clearfix">
                                  ...
                                  <div class="col-lg-3 col-lg-3 col-sm-3 " >
                                	  ...
                                	  <div class="col-lg-3 col-md-3 col-sm-3 ">
                               		...
                               		<div class="col-lg-3 col-md-3 col-sm-3">
                                        <button type="button" id="btnBuscarMascotaEncontrada" name="btnBuscarMascotaEncontrada" class="btn btn-primary btn-lg m-l-15 waves-effect">Buscar</button>
										<a  href="mascota_encontrada/mascota_encontrada_form"id="btnAddMascotaEncontrada" name="btnAddMascotaEncontrada" class="btn btn-primary btn-lg m-l-15 waves-effect">Agregar</a>
                                    </div>
                               </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            <table id="EncontrarMascotaGrid" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>NOMBRE</th>
    ...
    <script src="<c:url value="/js/pages/mascota_encontrada/mascota_encontrada.js"/>"></script>
