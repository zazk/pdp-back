...
<title>Ha sido ubicado este engreído, ayúdanos a que regrese con su familia</title>
	  ...
	  <div class = "row center foto-publicacion">
		...
		<div class="row black-text">
			<div class="col s12 m12 l12 center ">
				<h4 style="text-shadow: 1px 2px 2px #666;margin-bottom: 30px;">
				
				<c:choose>
				  <c:when test = "${item.mascotaNombre != null}" >
				     ${item.mascotaNombre}
				  </c:when>
				  <c:otherwise>
				     Un pata de Perro
			...
			<div class="col s12 m6 l6 etiquetas">
				<div class="row">
					<div class="col s4 m4 l4"> <b>Raza</b></div> <div class="col s8 m8 l8">
					
					<c:choose>
				  <c:when test = "${item.desRaza != null}" >
				     ${item.desRaza}
				  </c:when>
				  <c:otherwise>
				     NO ESPECIFICADO
				...
				<div class="row">
					<div class="col s4 m4 l4"> <b>Sexo</b></div> <div class="col s8 m8 l8">


				<c:choose>
				  <c:when test = "${item.desGenero != null}" >
				     ${item.desGenero}
				  </c:when>
				  <c:otherwise>
				     NO ESPECIFICADO
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		try{
			$('#fecEvento').html('Lo encontré el '+moment(new Date('${item.fechaEncontrado}')).format('DD/MM/YYYY hh:mm A'));
		}catch(e){}
