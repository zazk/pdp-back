     ...
     <div class="card">
 		<div class="body">
		 	   <ol class="breadcrumb breadcrumb-col-pink">
		               <li><a href="../mascota_encontrada">Lista Mascotas Encontradas</a></li>
		               <li class="active">${tituloEncontradaMascota}</li>
		        </ol>
                           
 	
 			<form id="formMascotaEncontrada_validation" name="formMascotaEncontrada_validation" method="POST" 
 			enctype="multipart/form-data" accept-charset="utf-8" >
		             ...
		             <div class="row clearfix">
 			 		...
 			 		<div class="row clearfix">  
 			 			<input type="hidden" id="dataEncontradaMascota" value='${dataEncontradaMascota}'/>
                      ...
                      <div class="row clearfix">
                       <div class="col-lg-3 col-md-3 col-sm-3 "> 
	                      		 <div class="input-group">
                                       ...
                                       <div class="form-line" >
                                           <input type="text"  name="fechaEncontrado" id="fechaEncontrado" class="datepicker"  placeholder="Fecha Encontrado/vio">
                                       </div>
                                  </div>
                      	 </div>
                      	  	<div class="col-lg-3 col-md-3 col-sm-3 ">
	                     		<div class="form-group form-float">
	                     		<label>Tipo Encuentro</label>
	                                   <select name="tipoEncuentro" id="tipoEncuentro" class="form-control show-tick">
	                                       <option value="0">-- Tipo Encuentro?--</option>
	                                       <option value="1">Vio</option>
	                                       <option value="2">Lo Tengo</option>
	                                   </select>
	                              </div> 
		                	</div>
		                    ...
		                    <div class="col-lg-2 col-md-2 col-sm-2 " id="generarPdf" hidden>
                     		  <div class="input-group">
                                       <span class="input-group-addon">
                                  		...
                                  		<a  href="#" target="_blank"  id="pdfMascotaEncontrada" name="pdfMascotaEncontrada" class="btn btn-success btn-lg m-l-15 waves-effect" download="posterMascota.pdf">Generar Pdf</a>
                                  </div>  
		                   </div>
...
<!--                      <div class="row clearfix">  
	...
	<script src="<c:url value="/js/pages/mascota_encontrada/mascota_encontrada_form.js"/>"></script>
	...
	<script src="<c:url value="/js/pages/mascota_encontrada/mascota_encontrada_mapa.js"/>"></script>
